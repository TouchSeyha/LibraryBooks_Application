...
namespace Book_Menu
{
    public partial class Book5 : Form
    {
        public Book5()
        {
            InitializeComponent();
        ...
        private async void Book5_Load(object sender, EventArgs e)
        {
        ...
        private async Task<string> LoadBookDataAsync()
        {
            ...
            try
            {
                ...
                FtpWebRequest requestData = (FtpWebRequest)WebRequest.Create("ftp://gutenberg.pglaf.org/6/0/0/0/60000/60000-8.txt");
                ...
                using (StreamWriter file = File.CreateText("The Living Animals of the World.txt"))
                {
